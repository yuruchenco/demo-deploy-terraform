...
output "firewall_private_ip" {
  description = "Private IP of the Azure Firewall (null if not deployed). Use as next hop in spoke UDRs."
...
output "log_analytics_workspace_id" {
  description = "Resource ID of the central Log Analytics workspace (null if not deployed)."
  value       = local.law_workspace_id
}

output "key_vault_id" {
  description = "Resource ID of the Hub Key Vault (null if not deployed)."
